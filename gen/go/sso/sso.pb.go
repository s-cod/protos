...
type RegisterResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User ID the registered user.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginResponse) GetTokken() string {
	if x != nil {
		return x.Tokken
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x06tokken\x18\x01 \x01(\tR\x06tokken\")\n" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x15Z\x13sofron.sso.v1;ssov1b\x06proto3"
